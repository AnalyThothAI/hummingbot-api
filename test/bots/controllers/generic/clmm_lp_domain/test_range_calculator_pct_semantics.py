...
def test_geometric_bounds_accepts_ratio_and_percent_points_width():
    center = Decimal("100")

    bounds_pct = RangeCalculator.geometric_bounds(center, Decimal("12"))  # 12%
    bounds_ratio = RangeCalculator.geometric_bounds(center, Decimal("0.12"))  # also 12%

    assert bounds_pct == bounds_ratio
